...
export default function ContactFooterSection() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setStatus('error');
      setErrorMessage('Network error. Please try again or text me at (559) 389-8850.');
    }
  }
      ...
      <div className="mx-auto" style={{ maxWidth: '1200px' }}>
        ...
        <div className="grid gap-16 md:grid-cols-2">
          ...
          <div ref={leftRef}>
            ...
            >
              Send a message and I’ll take a look at your website, workflow, or idea.
            </p>
          ...
          <div ref={rightRef}>
            {status === 'success' ? (
              ...
              >
                ...
                >
                  Got it. I'll get back to you within 24 hours — usually same day.
                </p>
                <p
                ...
                >
                  For anything urgent, text me at (559) 389-8850.
                </p>
              </div>
            ) : (
              <form
